...
Begin VB.Form frmNewAccount 
   ...
   Begin VB.Image cmdExit 
      ...
      Picture         =   "frmNewAccount.frx":000C
      Top             =   0
      Width           =   360
   End
   ...
   Begin VB.Image Image1 
      Height          =   870
      Left            =   0
      Picture         =   "frmNewAccount.frx":06F6
      Top             =   0
      Width           =   11025
   End
End
...
If txtUsername.Text <> "" Or txtPassword.Text <> "" Then
    ...
    connectDB
    With RS
        If frmAddRecord.cboStatus.Text = "Regular" Then
            CEmpSSS = .Fields!SSS
            CEmpPI = .Fields!Pagibig
            CEmpPH = .Fields!PhilHealth
        Else
            CEmpSSS = 0
            CEmpPI = 0
            CEmpPH = 0
    ...
    With RS
        .MoveLast
        .AddNew
        .Fields!EmployeeNo = frmAddRecord.txtEmpNo.Text
        .Fields!LastName = frmAddRecord.txtLastName.Text
        .Fields!FirstName = frmAddRecord.txtFirstName.Text
        .Fields!MiddleName = frmAddRecord.txtMName.Text
        .Fields!Gender = frmAddRecord.cboGender.Text
        .Fields!Age = frmAddRecord.txtAge.Text
        .Fields!Birthday = frmAddRecord.txtDBirth.Text
        .Fields!BirthPlace = frmAddRecord.txtPBirth.Text
        .Fields!Address = frmAddRecord.txtAddress.Text
        .Fields!ContactNo = frmAddRecord.txtContact.Text
        .Fields!Position = frmAddRecord.cboPosition.Text
        .Fields!SSS = CEmpSSS
        .Fields!Pagibig = CEmpPI
        .Fields!PhilHealth = CEmpPH
        .Fields!DateHired = frmAddRecord.txtHired.Text
        .Fields!Status = frmAddRecord.cboStatus.Text
        ...
        frmAddRecord.Clear_TextFields
        frmAddRecord.Generate_EmpNo
    End With
